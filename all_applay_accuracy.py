...
def learning(clf, X, Y):
    ...
    print('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
    predict = cross_val_predict(classifer,X_test_selected, Y_test, cv=10)
    print (classification_report(Y_test, predict))
    scores = cross_val_score(classifer,X_test_selected, Y_test, cv=10)
   
    print ("Accuracy of selectePercentile %s: %0.2f (+/- %0.2f)" % (classifer, scores.mean(), scores.std() *2))
    print('%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%')
    ...
    print ("Accuracy of selecteModel %s: %0.2f (+/- %0.2f)" % (classifer, scores.mean(), scores.std() *2))
...
csvFile.close()
count_data = featureExtraction2(data)
